...
var (
	...
	ErrMulticastForwardingAlreadyEnabled = New((&tcpip.ErrMulticastForwardingAlreadyEnabled{}).String(), errno.EINVAL)
)
...
func TranslateNetstackError(err tcpip.Error) *Error {
	...
	case *tcpip.ErrMulticastForwardingAlreadyEnabled:
		return ErrMulticastForwardingAlreadyEnabled
	default:
